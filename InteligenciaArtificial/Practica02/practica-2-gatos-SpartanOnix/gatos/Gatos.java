...
public class Gatos extends PApplet {
    ...
    private LinkedList<Gato> listaAbierta = new LinkedList<Gato>();  // Nodos en el nivel más profundo que no han sido expandidos.
    ...
    public void draw() {
        try {
            ...
            background(200);
            Gato actual;
            LinkedList<Gato> listaGatos = new LinkedList<Gato>();
