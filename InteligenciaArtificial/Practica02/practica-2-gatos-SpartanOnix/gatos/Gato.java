...
public class Gato {
     ...
     */
    private void hayGanador(int col, int ren, int marca) { // Intercambie los parametro ren por col
        // Horizontal
    ...
    private void tiraEn(int ren, int col) {
        ...
        tablero[col][ren] = marca; //Tuve que modificar la linea intercambaindo los valores de col y ren
                ...
                for(int j=0; j<3; j++){
                    if(tablero[i][j] == 0){
                        ...
                        for(Gato gat : sucesores){
                            if(gat.equals(gato)) igual = true;
                        }
                        if(!igual) sucesores.add(gato);
                    }
                }
            }
            return sucesores;
    ...
    boolean esSimetricoDiagonalInvertida(Gato otro) {
        ...
        table[0][0] = otro.tablero[0][0];
        table[0][1] = otro.tablero[1][0];
        table[0][2] = otro.tablero[2][0];
        table[1][0] = otro.tablero[0][1];
        table[1][1] = otro.tablero[1][1];
        table[1][2] = otro.tablero[2][1];
        table[2][0] = otro.tablero[0][2];
        table[2][1] = otro.tablero[1][2];
        table[2][2] = otro.tablero[2][2];
	    Gato gato = new Gato(otro);
        gato.tablero = table;
        return esIgual(gato);
    }
    ...
    boolean esSimetricoDiagonal(Gato otro) {
        // TODO: Tu código aquí.
        int[][] table = new int[3][3];
        table[0][0] = otro.tablero[2][2];
        table[0][1] = otro.tablero[1][2];
        table[0][2] = otro.tablero[0][2];
        table[1][0] = otro.tablero[2][1];
        table[1][1] = otro.tablero[1][1];
        table[1][2] = otro.tablero[0][1];
        table[2][0] = otro.tablero[2][0];
        table[2][1] = otro.tablero[1][0];
        table[2][2] = otro.tablero[0][0];
	    Gato gato = new Gato(otro);
        gato.tablero = table;
        return esIgual(gato);
    }
    ...
    boolean esSimetricoVerticalmente(Gato otro) {
        // TODO: Tu código aquí.
        int[][] table = new int[3][3];
        table[0][0] = otro.tablero[0][2];
        table[0][1] = otro.tablero[0][1];
        table[0][2] = otro.tablero[0][0];
        table[1][0] = otro.tablero[1][2];
        table[1][1] = otro.tablero[1][1];
        table[1][2] = otro.tablero[1][0];
        table[2][0] = otro.tablero[2][2];
        table[2][1] = otro.tablero[2][1];
        table[2][2] = otro.tablero[2][0];
	    Gato gato = new Gato(otro);
        gato.tablero = table;
        return esIgual(gato);
    }
    ...
    boolean esSimetricoHorizontalmente(Gato otro) {
        // TODO: Tu código aquí.
        int[][] table = new int[3][3];
        table[0][0] = otro.tablero[2][0];
        table[0][1] = otro.tablero[2][1];
        table[0][2] = otro.tablero[2][2];
        table[1][0] = otro.tablero[1][0];
        table[1][1] = otro.tablero[1][1];
        table[1][2] = otro.tablero[1][2];
        table[2][0] = otro.tablero[0][0];
        table[2][1] = otro.tablero[0][1];
        table[2][2] = otro.tablero[0][2];
	    Gato gato = new Gato(otro);
        gato.tablero = table;
        return esIgual(gato);
    }
