...
public class Termitas extends PApplet {
    ...
    //Para cada evolucion utilice las desndidades: Evo1:0.2f, Evo2:0.2f, Evo3:0.4f
    ...
    class ModeloTermitas {
        ...
        int direccionAleatoriaFrente(int direccion) {
            ...
            int aux = (move - 1) + direccion;
            move = aux % 8;
            if(move < 0)
              move = move + 8;
            //System.out.println("luego mira hacia "+ move);
            return move;
        }
        ...
        void dejarAstilla(Termita t, int dir) {
            ...
            t.cargando = false;
            int aux = t.direccion + 4;
            int move = aux % 8;
            this.moverTermita(t, move);
