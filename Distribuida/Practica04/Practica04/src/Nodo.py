...
class Nodo:
    ...
    Los métodos que tiene son únicamente getters y setters.
    """
    ...
    def get_eventos(self,evento,mensaje,emisor,receptores):
        '''Regresa los eventos'''
        aux = []
        for elem in receptores:
            aux.append([self.reloj,evento,mensaje,emisor,elem])
        return aux
