...
class Test:
    ''' Clase para las pruebas unitarias de la practica 1. '''
    # Las aristas de adyacencias de la grafica.
    adyacencias = [[1, 3, 4, 6], [0, 3, 5, 7], [3, 5, 6], [0, 1, 2], [0], [1, 2], [0, 2], [1]]

    def test_ejercicio_uno(self):
        ''' Metodo que prueba el algoritmo de BFS. '''
        # Creamos el ambiente y el objeto Canal
        env = simpy.Environment()
        bc_pipe = CanalRecorridos(env)

        # La lista que representa la grafica
        grafica = []
