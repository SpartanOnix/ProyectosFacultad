...
public class NodoBOLigado<C extends Comparable<C>> implements NodoBinario<C>{
  ...
  private int grado;
  private int altura;
  private List<Nodo<C>> lista = new ListaDoblementeLigada<>();
  private C elem;
  private NodoBOLigado<C> papa;
  ...
  */
  public NodoBinario<C> addNodo(C e){
    if (e.compareTo(elem) < 0){
      if (this.hijoI == null){
        this.hijoI = new NodoBOLigado(null, this, e, null);
        return this.hijoI;
      }else this.hijoI.addNodo(e);
    }else{
      if (this.hijoD == null){
        this.hijoD = new NodoBOLigado(null, this, e, null);
        return this.hijoD;
      }else this.hijoD.addNodo(e);
    }
    return null;
  }
  ...
  */
  public NodoBOLigado <C> busca(C elemento){
    NodoBOLigado <C> aux = obtenerRaiz();
    while (aux != null){
